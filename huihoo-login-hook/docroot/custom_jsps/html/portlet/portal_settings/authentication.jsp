...
<%@page import="com.liferay.portal.util.WeiboPropsKeys"%>
...
boolean weiboConnectAuthEnabled = WeiboConnectUtil.isEnabled(company.getCompanyId());
boolean weiboConnectVerifiedAccountRequired = WeiboConnectUtil.isVerifiedAccountRequired(company.getCompanyId());
String weiboConnectAppId = WeiboConnectUtil.getAppId(company.getCompanyId());
String weiboConnectAppSecret = WeiboConnectUtil.getAppSecret(company.getCompanyId());
String weiboConnectGraphURL = WeiboConnectUtil.getGraphURL(company.getCompanyId());
String weiboConnectOauthAuthURL = WeiboConnectUtil.getAuthURL(company.getCompanyId());
String weiboConnectOauthTokenURL = WeiboConnectUtil.getAccessTokenURL(company.getCompanyId());
String weiboConnectRedirectURL = WeiboConnectUtil.getRedirectURL(company.getCompanyId());
...
<liferay-ui:tabs
	names="general,ldap,cas,facebook,Google,Weibo,ntlm,open-id,open-sso,siteminder"
	refresh="<%= false %>"
>
	<liferay-ui:section>
		<aui:fieldset>
	...
	<liferay-ui:section>
		<aui:fieldset>
			<aui:input inlineLabel="left" label="enabled" name='<%= "settings--" + WeiboPropsKeys.WEIBO_CONNECT_AUTH_ENABLED + "--" %>' type="checkbox" value="<%= weiboConnectAuthEnabled %>" />

			<aui:input inlineLabel="left" label="verified-account-required" name='<%= "settings--" + WeiboPropsKeys.WEIBO_CONNECT_VERIFIED_ACCOUNT_REQUIRED + "--" %>' type="checkbox" value="<%= weiboConnectVerifiedAccountRequired %>" />

			<aui:input cssClass="lfr-input-text-container" label="application-id" name='<%= "settings--" + WeiboPropsKeys.WEIBO_CONNECT_APP_ID + "--" %>' type="text" value="<%= weiboConnectAppId %>" />

			<aui:input cssClass="lfr-input-text-container" label="application-secret" name='<%= "settings--" + WeiboPropsKeys.WEIBO_CONNECT_APP_SECRET + "--" %>' type="text" value="<%= weiboConnectAppSecret %>" />

			<aui:input cssClass="lfr-input-text-container" label="graph-url" name='<%= "settings--" + WeiboPropsKeys.WEIBO_CONNECT_GRAPH_URL + "--" %>' type="text" value="<%= weiboConnectGraphURL %>" />

			<aui:input cssClass="lfr-input-text-container" label="oauth-authentication-url" name='<%= "settings--" + WeiboPropsKeys.WEIBO_CONNECT_OAUTH_AUTH_URL + "--" %>' type="text" value="<%= weiboConnectOauthAuthURL %>" />

			<aui:input cssClass="lfr-input-text-container" label="oauth-token-url" name='<%= "settings--" + WeiboPropsKeys.WEIBO_CONNECT_OAUTH_TOKEN_URL + "--" %>' type="text" value="<%= weiboConnectOauthTokenURL %>" />

			<aui:input cssClass="lfr-input-text-container" label="redirect-url" name='<%= "settings--" + WeiboPropsKeys.WEIBO_CONNECT_OAUTH_REDIRECT_URL + "--" %>' type="text" value="<%= weiboConnectRedirectURL %>" />
		</aui:fieldset>
	</liferay-ui:section>
